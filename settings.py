...
mturk_hit_settings = {
    'keywords': ['decision-making', 'experiment'],
    'title': 'Part 2: Decision-Making Experiment',
    'description': '(Invite-only) Make interactive decisions with other participants over 100 rounds.',
    'frame_height': 500,
    'preview_template': 'global/MTurkPreview.html',
    'minutes_allotted_per_assignment': 120,
    'expiration_hours': 2, # 7 days
    'grant_qualification_id': '3V75YMGIEXLV6OXFC53VHC7DSC64NJ', # to prevent future retakes
    'qualification_requirements': [
        qualification.LocaleRequirement("EqualTo", "US"),
        qualification.PercentAssignmentsApprovedRequirement("GreaterThanOrEqualTo", 90),
        qualification.NumberHitsApprovedRequirement("GreaterThanOrEqualTo", 5),
        qualification.Requirement('3Z7S37PR6MOB0NGNNYA3GNSYP9T893', 'Exists'), # limit to screened players
